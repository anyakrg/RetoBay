    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-4">
                <a class="fancybox" rel="gallery_group" href="img/gallery-img.gif"><img src="img/gallery-img.gif"
                                                                                        alt=""/></a>
            </div>
            <div class="col-md-4 col-sm-4">
                <a class="fancybox" rel="gallery_group" href="img/gallery-img.gif"><img src="img/gallery-img.gif"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                ...
                <p>Proin eu leo non metus vulputate viverra. Curabitur ac augue ante. Praesent nisl diam, iaculis eget
                    ipsum at, blandit laoreet eros. Nam hendrerit, erat commodo varius consequat, dolor massa tempor
                    massa, vel cursus enim neque pellentesque augue. Aenean ullamcorper et lacus at hendrerit. Phasellus
                    id lectus luctus, congue quam id, tempor justo</p>
            </div>
            <div class="col-md-4">
                <h2>Praesent nisl diam</h2>
